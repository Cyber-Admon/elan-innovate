              ...
              >
                ...
                >
                  ...
                  <button
                    name="decision"
                    value="approved"
                    className="bg-strike px-4 py-2 text-xs font-bold uppercase tracking-widest text-paper hover:bg-ink"
                  >
                    Approve
                  </button>
                  <button
        ...
        <section>
          ...
          <div className="flex flex-col gap-2">
            {declined.map((u) => (
              <div
                key={u.id}
                className="flex flex-wrap items-center justify-between gap-4 border-2 border-ink/30 p-3"
              >
                <div>
                ...
                <form action="/api/admin/decide" method="post">
                  ...
                  <button
                    name="decision"
                    value="approved"
                    className="border-2 border-ink/40 px-4 py-2 text-xs font-bold uppercase tracking-widest text-ink/60 hover:bg-ink hover:text-paper"
                  >
                    Reinstate
                  </button>
                </form>
