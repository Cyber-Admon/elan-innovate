  ...
  return (
    <div className="flex flex-col gap-3">
      {visible.map((inv, i) => {
        ...
        // Within a duplicate group, the first occurrence (oldest, since
        // sorted ascending) is treated as the keeper.
        ...
        return (
          <div
            key={inv.token}
            className={`flex flex-wrap items-center justify-between gap-4 border-4 p-4 ${
          ...
          >
            ...
            <div className="flex items-center gap-2">
              {isDuplicateGroup && !isFirstOfGroup ? (
                ...
                >
                  {busyToken === inv.token ? "Removing..." : "Remove duplicate"}
                </button>
              ) : (
